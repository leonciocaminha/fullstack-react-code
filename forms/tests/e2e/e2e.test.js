...
module.exports = {
  'forms test case': function(client) {
    ...
    // 01
      .waitForElementPresent("//a[normalize-space(text())='01-basic-button.jsx']")
      .click("//a[normalize-space(text())='01-basic-button.jsx']")
      .useCss()
    ...
    // 02
      .waitForElementPresent("//a[normalize-space(text())='02-basic-button.jsx']")
      .click("//a[normalize-space(text())='02-basic-button.jsx']")
      .useCss()
      .waitForElementPresent("button[value='great']")
      .click("button[value='great']")
      .waitForElementPresent("button[value='amazing']")
    ...
    // 03
      .waitForElementPresent("//a[normalize-space(text())='03-basic-input.jsx']")
      .click("//a[normalize-space(text())='03-basic-input.jsx']")
    ...
    // 04
      .waitForElementPresent("//a[normalize-space(text())='04-basic-input.jsx']")
      .click("//a[normalize-space(text())='04-basic-input.jsx']")
    ...
    // 05
      .waitForElementPresent("//a[normalize-space(text())='05-state-input.jsx']")
      .click("//a[normalize-space(text())='05-state-input.jsx']")
    ...
    // 06
      .waitForElementPresent("//a[normalize-space(text())='06-state-input-multi.jsx']")
      .click("//a[normalize-space(text())='06-state-input-multi.jsx']")
      .useCss()
    ...
    // 07
      .waitForElementPresent("//a[normalize-space(text())='07-basic-validation.jsx']")
      .click("//a[normalize-space(text())='07-basic-validation.jsx']")
      .useCss()
      .waitForElementPresent("form input[name='name']")
      .click("form input[name='name']")
      .waitForElementPresent("input[name='name']")
    ...
    // 08
      .waitForElementPresent("//a[normalize-space(text())='08-field-component-form.jsx']")
      .click("//a[normalize-space(text())='08-field-component-form.jsx']")
      .useCss()
    ...
    // 09
      .waitForElementPresent("//a[normalize-space(text())='09-async-fetch.jsx']")
      .click("//a[normalize-space(text())='09-async-fetch.jsx']")
      .useCss()
    ...
    // 10
      .waitForElementPresent("//a[normalize-space(text())='10-remote-persist.jsx']")
      .click("//a[normalize-space(text())='10-remote-persist.jsx']")
      .useCss()
      .waitForElementPresent("input[Placeholder='Name']")
      .click("input[Placeholder='Name']")
      .clearValue("div:nth-child(13) form div:nth-child(1) input")
    ...
    // 11
      .waitForElementPresent("//a[normalize-space(text())='11-redux-app.jsx']")
      .click("//a[normalize-space(text())='11-redux-app.jsx']")
      .useCss()
      .waitForElementPresent("input[Placeholder='Name']")
      .click("input[Placeholder='Name']")
      .clearValue("div:nth-child(13) form div:nth-child(1) input")
